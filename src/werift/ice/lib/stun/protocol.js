...
class StunProtocol {
    constructor(receiver) {
        ...
        this.connectionMade = (useIpv4) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (!useIpv4) {
                this.socket = dgram.createSocket("udp6");
            }
            this.socket.bind();
            yield new Promise((r) => this.socket.once("listening", r));
    ...
    request(request, addr, integrityKey, retransmissions) {
