...
exports.RtpPacket = exports.RtpHeader = void 0;
...
class RtpHeader {
    ...
    static deSerialize(rawPacket) {
        ...
        h.version = utils_1.getBit(v_p_x_cc, 0, 2);
        h.padding = utils_1.getBit(v_p_x_cc, 2) > 0;
        h.extension = utils_1.getBit(v_p_x_cc, 3) > 0;
        const cc = utils_1.getBit(v_p_x_cc, 4, 4);
        h.csrc = [...Array(cc)].map(() => {
        ...
        h.marker = utils_1.getBit(m_pt, 0) > 0;
        h.payloadType = utils_1.getBit(m_pt, 1, 7);
    ...
    serialize(size) {
        ...
        let offset = 0;
        const v_p_x_cc = new utils_1.BitWriter(8);
        ...
        const m_pt = new utils_1.BitWriter(8);
        if (this.marker)
            m_pt.set(1, 0, 1);
